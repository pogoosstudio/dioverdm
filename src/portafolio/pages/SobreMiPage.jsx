            ...
            <section className={`${clases.about__personalInfo}`}>
                <article className={`${clases.personalInfo__bio}`}>
                    <p className={`${clases.personalInfo__description}`}>
                        ...
                        y la música. Mis hobbies actuales son tocar el piano y jugar videojuegos. Mis metas
                ...
                <div className={`${clases.personalInfo__data}`}>
                    <ul className={`${clases.personalInfo__list}`}>
                        ...
                        <li className={`${clases.personalInfo__option}`}>
                            ...
                            <span className={`${clases.personalInfo__value}`}>contact@dioverdm.com</span>
                        </li>
                        <li className={`${clases.personalInfo__option}`}>
                            <span className={`${clases.personalInfo__title}`}>Telefono</span>
                            <span className={`${clases.personalInfo__value}`}>+58 4248433917</span>
                        </li>
                    </ul>
                </div>
            </section>
                    ...
                    <article className={`${clases.services__service}`}>
                        ...
                        <div className={`${clases.service__content}`}>
                            ...
                            <p className={`${clases.service__description}`}>
                                Mi aprendizaje en programación comenzo a mis 14 años de edad donde aprendí 
                                lo mas basico de Javascript y a hacer consultas a la DB. 
                                Luego aprendí un poco de programación con Python (aunque no me gusta usarlo es útil), que fue lo 
